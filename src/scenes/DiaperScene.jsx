  ...
  return (
    <Scene id="diapers" labelledBy="diapers-title" tone="yellow">
      <div className="scene-copy">
        ...
        <div className="chart-frame" aria-label="Static preview of daily diaper count tapering to zero">
          ...
          <svg viewBox="0 0 520 190" aria-hidden="true">
            ...
            <path className="chart-frame__line" d="M30 38C94 36 104 53 145 62S205 81 244 94S321 115 356 127S421 145 489 158" />
